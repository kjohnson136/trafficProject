...
cap = cv2.VideoCapture('4Carsrr.mp4')
...
with open('trajectories.csv', 'w', newline='') as csvfile:
    ...
    csv_writer.writerow(['frame', 'trackID', 'xCenter', 'yCenter'])
    ...
    while True:
        ...
        for track_id, (x, y) in tracks.items():
            csv_writer.writerow([frame_count, track_id, x, y])
...
print("CSV file 'trajectories.csv' has been created.")
